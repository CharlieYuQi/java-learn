...
public class StatusOrChecker implements StatusValidator {

    private List<StatusValidator> subCheckers = new ArrayList<StatusValidator>();

    public StatusOrChecker(List<StatusValidator> subCheckers) {
        this.subCheckers = subCheckers;
    }

    public StatusOrChecker(StatusValidator... subCheckers) {
